...
const TRANSLATIONS: Record<string, Record<string, string>> = {
  en: {
    ...
    'settings.memory.add.placeholder': 'Something you want me to remember...',
    'settings.memory.edit': 'Edit',
    'settings.memory.save': 'Save',
    'settings.memory.cancel': 'Cancel',
    'settings.emoji.title': 'Emoji Density',
    'settings.emoji.hint': 'How often I sprinkle emojis into my replies.',
    ...
    // bg50..bg74 — CC0 plein-air / watercolor / tonalist (CMA OpenAccess)
    'bg.label.bg50': 'Corot Pond',
    'bg.label.bg51': 'Foggy Port',
    'bg.label.bg52': 'Pissarro Village',
    'bg.label.bg53': 'Canal Bend',
    'bg.label.bg54': 'Boudin Harbor',
    'bg.label.bg55': 'Coast Storm',
    'bg.label.bg58': 'Water Lilies · Agapanthus',
    'bg.label.bg59': 'Riverbank',
    'bg.label.bg60': 'Sisley Canal',
    'bg.label.bg61': 'Sea & Clouds',
    'bg.label.bg62': 'Monet Garden',
    'bg.label.bg65': 'Storm Wave',
    'bg.label.bg66': 'Roman Hills',
    'bg.label.bg67': 'Olive Hills',
    'bg.label.bg68': 'Hudson Lake',
    'bg.label.bg69': 'Winter Sunset',
    'bg.label.bg70': 'Lake at Dusk',
    'bg.label.bg71': 'Sunset Town',
    'bg.label.bg72': 'Dusk River',
    'bg.label.bg73': 'Cloud Vista',
    'bg.label.bg74': 'Barbizon Field',
    // bg75..bg85 — Monet greatest hits (AIC + CMA OpenAccess)
    'bg.label.bg75': 'Water Lilies',
    'bg.label.bg76': 'Water Lily Pond',
    'bg.label.bg77': 'Pourville Cliff',
    'bg.label.bg78': 'Giverny Mist',
    'bg.label.bg79': 'Poppy Field',
    'bg.label.bg80': 'Haystack · Summer',
    'bg.label.bg81': 'Haystack · Autumn',
    'bg.label.bg82': 'London Parliament',
    'bg.label.bg83': 'Bordighera',
    ...
    // ---- Expression System ----
    'expr.create_btn': '✨ Live Portrait',
    'expr.title': '✨ Live Portrait',
    'expr.subtitle': 'Create an animated character that reacts to your conversations',
    'expr.intro': 'Live Portrait generates an animated avatar from your character description. Supports anime characters, real people, or original designs. It creates 8 emotion expressions with idle animations. The avatar appears above the chat input box and changes expression based on conversation mood. Tap it anytime to edit.',
    'expr.appearance_label': 'Character Appearance',
    'expr.appearance_placeholder': 'Describe your character\'s appearance: hair color, eye color, outfit...',
    'expr.appearance_tip': 'Tip: Include hair color, eye color, outfit, and style for best results',
    'expr.style_label': 'Art Style',
    'expr.style.anime': 'Anime',
    'expr.style.anime_desc': 'Japanese animation style',
    'expr.style.realistic': 'Realistic',
    'expr.style.realistic_desc': 'Photorealistic portrait',
    'expr.style.3d': '3D Render',
    'expr.style.3d_desc': 'Game-like 3D style',
    'expr.style.illustration': 'Illustration',
    'expr.style.illustration_desc': 'Digital painting',
    'expr.style_recommended': 'Recommended',
    'expr.style_detecting': 'Detecting style...',
    'expr.generate_btn': 'Generate Live Portrait',
    'expr.generate_time': 'Takes ~5 minutes \u00B7 8 emotions + idle animations',
    'expr.generating': 'Creating Live Portrait...',
    'expr.generating_wait': 'You can close this and come back to check progress',
    'expr.step.1': 'Generating character keyframes...',
    'expr.step.2': 'Uploading to cloud...',
    'expr.step.3': 'Creating expression videos...',
    'expr.step.4': 'Creating idle animations...',
    'expr.step.5': 'Finalizing...',
    'expr.preview_title': '\uD83C\uDF89 Preview Live Portrait',
    'expr.preview_use': 'Activate',
    'expr.preview_redo': 'Regenerate',
    'expr.deactivate': 'Deactivate',
    'expr.done_title': 'Expressions Active!',
    'expr.done_desc': 'Your character will now react with emotions while chatting',
    'expr.done_btn': 'Start Chatting',
    'expr.error_retry': 'Try Again',
    'expr.error_close': 'Close',
    'expr.guest_error': 'Sign up to create character expressions',
    'expr.no_appearance': 'Please describe your character\'s appearance',
    'expr.emotion.neutral': 'Calm',
    'expr.emotion.happy': 'Happy',
    'expr.emotion.sad': 'Sad',
    'expr.emotion.angry': 'Angry',
    'expr.emotion.surprised': 'Surprised',
    ...
    'expr.cost_title': 'Estimated cost per generation',
    'expr.cost.keyframes': 'Character keyframes (Venice + FLUX)',
    'expr.cost.videos': 'Emotion videos × 8 (Kling / Wan)',
    'expr.cost.matting': 'Background removal (BiRefNet)',
    'expr.cost.misc': 'Storage & translation (Cloudinary, Gemini)',
    'expr.cost_note_cheaper_coming': 'The video step dominates the bill. We\'re working on a much cheaper pipeline — these limits will relax once it ships.',
    'expr.quota_title': 'Usage this window',
    'expr.quota_rule': 'Limit: 1 generation per 24h, max 2 per 5 days.',
    'expr.quota_daily_blocked': 'Daily limit reached. Next slot opens around {when}.',
    'expr.quota_window_blocked': '5-day limit reached (2/2). Next slot opens around {when}.',
    'expr.quota_blocked': 'You\'ve hit the generation limit. Try again later.',
  },
  ...
  'zh-CN': {
    ...
    'settings.memory.add.placeholder': '\u8BB0\u4E0B\u4E00\u4EF6\u4F60\u5E0C\u671B\u6211\u8BB0\u5F97\u7684\u4E8B...',
    'settings.memory.edit': '\u7F16\u8F91',
    'settings.memory.save': '\u4FDD\u5B58',
    'settings.memory.cancel': '\u53D6\u6D88',
    'settings.emoji.title': 'Emoji \u5BC6\u5EA6',
    'settings.emoji.hint': '\u63A7\u5236\u56DE\u590D\u4E2D emoji \u7684\u4F7F\u7528\u9891\u7387',
    'settings.emoji.none': '\u7981\u7528',
    ...
    'bg.label.bg16': '\u62BD\u8C61',
    'bg.label.bg17': '\u591C\u666F\u6CB3\u7554',
    // bg50..bg74 \u2014 CC0 plein air / \u6C34\u5F69 / tonalist\uFF08CMA OpenAccess\uFF09
    'bg.label.bg50': '\u67EF\u6D1B\u6C60\u5858',
    'bg.label.bg51': '\u96FE\u6E2F',
    'bg.label.bg52': '\u6BD5\u6C99\u7F57\u6751',
    'bg.label.bg53': '\u8FD0\u6CB3\u5F2F',
    ...
    'bg.label.bg73': '\u8FDC\u4E91',
    'bg.label.bg74': '\u6BD4\u677E\u7530\u91CE',
    // bg75..bg85 \u2014 Monet \u540D\u4F5C\u96C6\uFF08AIC + CMA OpenAccess\uFF09
    'bg.label.bg75': '\u7761\u83B2',
    'bg.label.bg76': '\u7761\u83B2\u6C60',
    'bg.label.bg77': 'Pourville \u60AC\u5D16',
    'bg.label.bg78': 'Giverny \u6668\u96FE',
    'bg.label.bg79': '\u7F42\u7C9F\u7530',
    'bg.label.bg80': '\u5E72\u8349\u5806\u00B7\u590F\u672B',
    'bg.label.bg81': '\u5E72\u8349\u5806\u00B7\u79CB\u65E5',
    'bg.label.bg82': '\u4F26\u6566\u56FD\u4F1A',
    'bg.label.bg83': 'Bordighera',
    'bg.label.bg84': 'Charing Cross \u6865',
    'bg.label.bg85': 'Pourville \u9000\u6F6E',
    // \u5206\u7C7B\u6807\u7B7E
    'bg.cat.monet': '\u83AB\u5948',
    'bg.cat.painting': '\u753B\u4F5C',
    'bg.cat.photo': '\u6444\u5F71',
    ...
    'expr.create_btn': '✨ 微立绘',
    'expr.title': '✨ 微立绘',
    'expr.subtitle': '创建一个能跟随对话情绪变化的动态角色',
    'expr.intro': '微立绘会根据你的角色描述生成动态头像，支持动漫角色、真实人物或原创形象。包含 8 种表情（开心、难过、生气等），每种都有待机动画。生成后角色会出现在聊天输入框上方，根据对话情绪自动切换表情。点击立绘可随时编辑。',
    'expr.appearance_label': '角色外貌描述',
    'expr.appearance_placeholder': '描述角色外貌：发色、瞳色、服装、风格...',
    'expr.appearance_tip': '提示：包含发色、瞳色、服装和风格效果最好',
    'expr.style_label': '画风',
    'expr.style.anime': '动漫',
    'expr.style.anime_desc': '日系动画风格',
    'expr.style.realistic': '写实',
    'expr.style.realistic_desc': '真实人像风格',
    'expr.style.3d': '3D 渲染',
    'expr.style.3d_desc': '游戏 CG 风格',
    'expr.style.illustration': '插画',
    'expr.style.illustration_desc': '数字绘画风格',
    'expr.style_recommended': '推荐',
    'expr.style_detecting': '正在识别角色类型...',
    'expr.generate_btn': '开始生成微立绘',
    'expr.generate_time': '预计 ~5 分钟 · 8 种表情 + 待机动画',
    'expr.generating': '正在创建微立绘...',
    'expr.generating_wait': '可以关闭此窗口，稍后回来查看进度',
    'expr.step.1': '生成角色关键帧...',
    'expr.step.2': '上传到云端...',
    'expr.step.3': '创建表情视频...',
    'expr.step.4': '创建待机动画...',
    'expr.step.5': '最终处理...',
    'expr.preview_title': '🎉 预览微立绘效果',
    'expr.preview_use': '启用',
    'expr.preview_redo': '重新生成',
    'expr.deactivate': '停用立绘',
    'expr.done_title': '表情已激活！',
    'expr.done_desc': '角色会在聊天时跟随情绪变化表情',
    'expr.done_btn': '开始聊天',
    'expr.error_retry': '重试',
    'expr.error_close': '关闭',
    'expr.guest_error': '注册后可以创建角色表情',
    'expr.no_appearance': '请描述角色的外貌特征',
    'expr.emotion.neutral': '平静',
    'expr.emotion.happy': '开心',
    'expr.emotion.sad': '难过',
    'expr.emotion.angry': '生气',
    'expr.emotion.surprised': '惊讶',
    'expr.emotion.shy': '害羞',
    'expr.emotion.thinking': '思考',
    'expr.emotion.loving': '喜爱',
    'expr.history_title': '历史生成（点击切换）',
    'expr.cost_title': '每次生成成本估算',
    'expr.cost.keyframes': '角色关键帧（Venice + FLUX）',
    'expr.cost.videos': '表情动画视频 × 8（Kling / Wan）',
    'expr.cost.matting': '背景抠图（BiRefNet）',
    'expr.cost.misc': '存储与翻译（Cloudinary、Gemini）',
    'expr.cost_note_cheaper_coming': '视频步骤占了绝大部分成本。我们正在开发更便宜的管线，上线后会放宽限制。',
    'expr.quota_title': '当前窗口使用',
    'expr.quota_rule': '限制：24 小时内 1 次，5 天内最多 2 次。',
    'expr.quota_daily_blocked': '今日已达上限，下一次可用时间：{when}。',
    'expr.quota_window_blocked': '已达 5 天限额 (2/2)，下一次可用时间：{when}。',
    'expr.quota_blocked': '已达生成次数限制，请稍后再试。',
  },
};
