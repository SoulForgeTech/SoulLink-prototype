...
const TRANSLATIONS: Record<string, Record<string, string>> = {
  en: {
    ...
    // bg20..bg49 — CC0 ink-landscape set (CMA OpenAccess); see manifest.csv
    'bg.label.bg20': 'Spring Hills',
    'bg.label.bg21': 'Album · Houses',
    'bg.label.bg22': 'West Lake',
    'bg.label.bg27': 'Spring Plowing',
    'bg.label.bg32': 'Yellow Mtn',
    'bg.label.bg42': 'Autumn Scholar',
    'bg.label.bg45': 'Coastal',
    'bg.label.bg49': 'Album · Stream',
    // bg50..bg64 — CC0 impressionist set (CMA OpenAccess); see manifest.csv
    ...
    'bg.label.bg56': 'Winter Yard',
    'bg.label.bg57': 'Seurat Study',
    'bg.label.bg58': 'Water Lilies',
    'bg.label.bg59': 'Riverbank',
    'bg.label.bg60': 'Sisley Canal',
    'bg.label.bg61': 'Sea & Clouds',
    'bg.label.bg62': 'Monet Garden',
    'bg.label.bg63': 'Cézanne River',
    'bg.label.bg64': 'Plane Trees',
    // Category labels for BackgroundPicker top tabs
    'bg.cat.ink': 'Ink Wash',
    'bg.cat.impressionist': 'Impressionist',
    'bg.cat.photo': 'Photo',
  ...
  'zh-CN': {
    ...
    'bg.label.bg16': '\u62BD\u8C61',
    'bg.label.bg17': '\u591C\u666F\u6CB3\u7554',
    // bg20..bg49 \u2014 CC0 \u6C34\u58A8\u5C71\u6C34\u96C6\uFF08CMA OpenAccess\uFF0C8 \u5F20\u7CBE\u9009\uFF09
    'bg.label.bg20': '\u6625\u5C71',
    'bg.label.bg21': '\u5C4B\u820D\u518C\u9875',
    'bg.label.bg22': '\u897F\u6E56',
    'bg.label.bg27': '\u6625\u8015',
    ...
    'bg.label.bg45': '\u6D77\u5CB8',
    'bg.label.bg49': '\u6D41\u6C34\u518C\u9875',
    // bg50..bg64 \u2014 CC0 \u5370\u8C61\u6D3E\u96C6\uFF08CMA OpenAccess\uFF09
    'bg.label.bg50': '\u67EF\u6D1B\u6C60\u5858',
    'bg.label.bg51': '\u96FE\u6E2F',
    'bg.label.bg52': '\u6BD5\u6C99\u7F57\u6751',
    'bg.label.bg53': '\u8FD0\u6CB3\u5F2F',
