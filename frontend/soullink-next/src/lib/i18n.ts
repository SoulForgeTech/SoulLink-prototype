...
const TRANSLATIONS: Record<string, Record<string, string>> = {
  en: {
    ...
    // bg18..bg49 — CC0 ink-landscape set (CMA OpenAccess); see manifest.csv
    'bg.label.bg18': 'Lake View',
    'bg.label.bg19': 'After Ni Zan',
    'bg.label.bg20': 'Spring Hills',
    'bg.label.bg21': 'Album · Houses',
    'bg.label.bg22': 'West Lake',
    'bg.label.bg23': 'Mountain Brook',
    'bg.label.bg24': 'Album · Cliffs',
    'bg.label.bg25': 'After Mi Fei',
    'bg.label.bg26': 'Album · Boatmen',
    'bg.label.bg27': 'Spring Plowing',
    'bg.label.bg28': 'Album · Waterfall',
    'bg.label.bg29': 'Album · Hills',
    'bg.label.bg30': 'After Masters I',
    'bg.label.bg31': 'Album · Sketch',
    'bg.label.bg32': 'After Masters II',
    'bg.label.bg33': 'After Masters III',
    'bg.label.bg34': 'Autumn Travel',
    'bg.label.bg35': 'After Masters IV',
    'bg.label.bg36': 'Spring Boating',
    'bg.label.bg37': 'After Masters V',
    'bg.label.bg38': 'Wuling Stream',
    'bg.label.bg39': 'After Masters VI',
    'bg.label.bg40': 'Mt. Changbai',
    'bg.label.bg41': 'Misty Cottages',
    'bg.label.bg42': 'Autumn Scholar',
    'bg.label.bg43': 'After Masters VII',
    'bg.label.bg44': 'Album · Bridge',
    'bg.label.bg45': 'Coastal',
    'bg.label.bg46': 'After Masters VIII',
    'bg.label.bg47': 'After Masters IX',
    'bg.label.bg48': 'After Masters X',
  ...
  'zh-CN': {
    ...
    'bg.label.bg16': '\u62BD\u8C61',
    'bg.label.bg17': '\u591C\u666F\u6CB3\u7554',
    // bg18..bg49 \u2014 CC0 \u6C34\u58A8\u5C71\u6C34\u96C6\uFF08CMA OpenAccess\uFF09\uFF0C\u6E90\u5904\u89C1 manifest.csv
    'bg.label.bg18': '\u6E56\u666F',
    'bg.label.bg19': '\u4EFF\u502A\u74D2',
    'bg.label.bg20': '\u6625\u5C71',
    'bg.label.bg21': '\u5C4B\u820D\u518C\u9875',
