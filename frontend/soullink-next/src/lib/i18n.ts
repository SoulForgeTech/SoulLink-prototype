...
const TRANSLATIONS: Record<string, Record<string, string>> = {
  en: {
    ...
    'expr.intro': 'Live Portrait generates an animated avatar from your character description. It creates 8 emotion expressions (happy, sad, angry, etc.) with idle animations. The avatar appears above the chat input box and changes expression based on conversation mood. Tap it anytime to edit.',
  ...
  'zh-CN': {
    ...
    'expr.intro': '微立绘会根据你的角色描述生成动态头像，包含 8 种表情（开心、难过、生气等），每种都有待机动画。生成后角色会出现在聊天输入框上方，根据对话情绪自动切换表情。点击立绘可随时编辑。',
