...
const TRANSLATIONS: Record<string, Record<string, string>> = {
  en: {
    ...
    // ---- Expression System ----
    'expr.create_btn': '✨ Create Animated Character',
    'expr.title': '✨ Create Character Animation',
    'expr.subtitle': 'Generate animated expressions for your companion',
    ...
    'expr.generate_btn': 'Generate Expressions',
    'expr.generate_time': 'Takes ~5 minutes \u00B7 8 emotions + idle animations',
    'expr.generating': 'Generating Expressions...',
    'expr.generating_wait': 'You can close this and come back to check progress',
    'expr.preview_title': '\uD83C\uDF89 Preview Expressions',
    'expr.preview_use': 'Use These Expressions',
    'expr.preview_redo': 'Redo',
  ...
  'zh-CN': {
    ...
    // ---- Expression System ----
    'expr.create_btn': '✨ 创建动态立绘',
    'expr.title': '✨ 创建角色动画',
    'expr.subtitle': '为你的角色生成动态表情',
    ...
    'expr.generate_btn': '开始生成',
    'expr.generate_time': '预计 ~5 分钟 · 8 种表情 + 待机动画',
    'expr.generating': '正在生成表情...',
    'expr.generating_wait': '可以关闭此窗口，稍后回来查看进度',
    'expr.preview_title': '🎉 预览表情效果',
    'expr.preview_use': '使用这套表情',
